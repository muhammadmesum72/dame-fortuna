  ...
  return (
    <div id="home" className="h-screen flex items-center justify-center">
      <div className="w-full flex items-center">
        <div className="md:basis-1/2 space-y-3 md:space-y-6">
          <span>Ultimate Guide To Astrology</span>
          <h2 className="text-3xl md:text-6xl leading-10 text-primary  ">Your Star Determines <br /> Your Life's Journey</h2>
          ...
          <button className="border-2 border-white rounded-xl px-6 py-3 hover:border-primary hover:bg-primary hover:text-[#0a0822] font-bold md:text-xl ">Mint Nft</button>
        </div>
